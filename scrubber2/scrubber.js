...
Ext.onReady( function() {
	...
	*/
            ...
            },
            {
                ...
                region: 'east',
                split: true,    // split so east/center is resizable
                border: false,
                ...
                items: [
                    {  
                        ...
                        split: true,        // split so it can be 
                                            // resizable
                        region: 'north',   // must have center with
                                            // border layout
			height: 300,
            ...
            },
            {
                ...
                title: 'This will show the scrubbed text.',
...
*/
    initComponent: function() {
        ...
        Stopwords.superclass.initComponent.apply( this, arguments );
    }
});
...
*/
    initComponent: function() {
        ...
        Lemmas.superclass.initComponent.apply( this, arguments );
    }
});
...
*/
    initComponent: function() {
                ...
                },*/
		{
                    ...
                    title: 'Orthography',
                    border: false,
                    contentEl: 'orthography'
                }
            ]
        });
        Orthography.superclass.initComponent.apply( this, arguments );
    }
});
        ...
        Ext.Ajax.request({
            ...
            success: function( r, o ) {
                ...
                if ( text )
                {
                    ...
                    // the change in text
                    cpp.setTitle( "Scrubbing -- " + textname );
